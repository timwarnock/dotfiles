...
The scope gate sent you here: you are changing
production-code behavior, fixing a bug, or refactoring production code. Pick the
matching mode below. Anything else — docs, config, analysis, review, mechanical
renames, non-production code — does not belong here.
